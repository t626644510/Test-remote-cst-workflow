...
# ---------------------------------------------------------------------------
# Record 鈫?PriorCandidate conversion
# ---------------------------------------------------------------------------
...
# ===================================================================
# WS3.1 鈥?Pure no-CST helpers for checkpoint-dedup merging
# ===================================================================
...
def merge_checkpoint_and_db_priors(
    ...
    Checkpoint observations remain authoritative 鈥?any DB prior whose
