...
from .solver import SolverResult, SolverRunner
...
class DualProjectOrchestrator:
    ...
    def execute(
        ...
        if _recording:
            from ..database import start_recording_session, make_recording_reader
        ...
        if start_phase == "f2w":
            ...
            from ..database import VirtualResultReader
        ...
        try:
            ...
            if _recording:
                from ..database import collect_curves, save_curves_npz, save_index_record
    ...
    def _execute_phase_1(
        ...
        for spec in self._specs:
            ...
            from .cleanup import remove_result_folder, remove_lock_file
