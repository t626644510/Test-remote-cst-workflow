...
#
# Phase SR2 鈥?no-CST lookup implementation.
...
def _is_row_eligible(
    ...
    # Raw-only rows are never eligible 鈥?no safe recompute helper exists.
    ...
    # Max age check is not implemented in SR2 鈥?raise if set.
