"""Phase 2 HOM Antenna Optimisation — entry point.
...
# Ensure the src/ directory is on the Python path (no pip install needed)
...
def main() -> None:
    ...
    if has_ckpt:
        ...
        if partial:
            ...
            # Processed below after orchestrator is built
    ...
    orch, opt, evaluator, retry_handler = build_workflow_2(wf2_cfg, checkpoint_callback=_on_evaluation)
