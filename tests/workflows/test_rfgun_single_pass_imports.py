...
WF1_PACKAGE = _PROJECT_ROOT / "workflows" / "rfgun_single_pass"
...
def test_import_runner_without_cst():
    import workflows.rfgun_single_pass.run as run_mod
...
def test_cli_parser_accepts_expected_flags():
    from workflows.rfgun_single_pass.run import build_arg_parser
