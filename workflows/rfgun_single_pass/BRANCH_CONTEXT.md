...
3. Every phase must add or update a report in `reports/workflow1_split/`
   ...
   output.
4. Every phase must run `python -m compileall src workflows run_workflow_1.py`
...
| 2 | Directory skeleton + scaffold report |
| 3 | Runner migration |
| 4 | Evaluator extraction |
| 5 | Config + objectives extraction |
| 6 | Tests |
