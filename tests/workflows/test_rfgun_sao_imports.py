...
def test_types_py_reexports_shared_contract():
    """Workflow 1 uses the shared evaluation contract from strict ``main``."""
    from cst_optimization.workflows.recovery import (
        EvaluationResult as SharedResult,
        EvaluationStatus as SharedStatus,
    )
    from workflows.rfgun_sao.types import EvaluationResult, EvaluationStatus

    assert EvaluationResult is SharedResult
    assert EvaluationStatus is SharedStatus
