...
from cst_optimization.evaluation.dedup import (
    DedupDecisionAction,
...
def derive_stage_observations_from_prior_candidates(
    ...
    Uses delayed import from ``workflows.rfgun_sao.stage_search`` to
    avoid a shared-core → workflow-local dependency at module level.
    """
...
def load_warm_start_priors(
    ...
    *,
    ...
    """
    from cst_optimization.evaluation.schema import current_schema_version
    import math
