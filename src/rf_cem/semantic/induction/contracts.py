...
def load_family_extension_proposal(path: Path) -> FamilyExtensionProposal:
    return FamilyExtensionProposal.from_mapping(
        _read_mapping(path, "family extension proposal")
    )
